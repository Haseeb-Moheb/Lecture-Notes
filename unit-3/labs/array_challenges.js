...
/*
    ...
    - And replace one of your existing movies with another one.
        - Use .forEach() to list your movies
*/
// let movies = ['A new hope', 'The empire strike bakc', 'Returne of the jedi', 'Revenge of the sith'];
...
// movies.splice (4, 1, 'The phontom mence');
// console.log(movies);

let movies = [ 'Bee Moive', "Horton Hears a Who", "The Grinch", "The Lorax"];
